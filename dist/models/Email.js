...
const SignEmail_1 = __importDefault(require("./SignEmail"));
...
__decorate([
    ...
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Email.prototype, "contactListId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => SignEmail_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Email.prototype, "dkimId", void 0);
Email = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "CampaignEmail" })
], Email);
